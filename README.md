...
I work as a Senior Deep Learning Scientist at Pi School.
...
- Work projects that I've led or contributed to:
     ...
     - [SCEVA](https://github.com/esa-sceva) (Co-Lead and Technical Officer): A open science initiative funded by the European Space Agency, to develop suite of dataset and domain specific LLMs, which aims to advance the use of Large Language Models (LLMs) for satellite communications.
...
- Personal Projects
     ...
     - [Roadscapes](https://github.com/vijpandaturtle/roadscapes): A multi-task, multimodal dataset for Indian roads and highways.
     - [Roadscapes-Video](https://github.com/vijpandaturtle/roadscapes-video-rag): A multimodal/video dataset for understanding/explaining driving actions/providing driving advice. 
